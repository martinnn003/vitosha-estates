...
export const PROPERTIES = [
  ...
  { id: 11, title: "Simeonovo", location: "Simeonovo, Sofia", type: "Townhouse", status: "sale", price: 540000, beds: 4, baths: 3, area: 265, amenities: ["Garden", "Garage", "Terrace", "Security"], img: IMG("1600566753190-17f0baa2a6c3"), gradient: "from-stone-700 via-slate-800 to-slate-900", icon: Home, featured: false, x: 60, y: 76, desc: "Corner townhouse in a boutique gated community near the Simeonovo lift. Private garden, roof terrace and mountain views from every floor." },
  { id: 12, title: "Bistritsa Mountain", location: "Bistritsa, Sofia", type: "Villa", status: "rent", price: 2500, beds: 5, baths: 4, area: 380, amenities: ["Pool", "Garden", "Garage", "Fireplace", "Gym"], img: IMG("1613490493576-7fde63acd811"), gradient: "from-emerald-900 via-slate-900 to-slate-950", icon: Trees, featured: false, x: 75, y: 91, desc: "Long-let mountain retreat with indoor pool, sauna and panoramic terraces — twenty minutes from the business district." },
];
